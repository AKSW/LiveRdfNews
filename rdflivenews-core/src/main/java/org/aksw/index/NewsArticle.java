...
public class NewsArticle {
    ...
    private String text = "";
    private String nerTaggedText = "";
    private String posTaggedText = "";
    ...
    /**
     * @return the nerTaggedText
     */
    public String getNerTaggedText() {
    
        return nerTaggedText;
    }


    
    /**
     * @param nerTaggedText the nerTaggedText to set
     */
    public void setNerTaggedText(String nerTaggedText) {
    
        this.nerTaggedText = nerTaggedText;
    }


    
    /**
     * @return the posTaggedText
     */
    ...
    /**
     * @param posTaggedText the posTaggedText to set
     */
    public void setPosTaggedText(String posTaggedText) {
    
        this.posTaggedText = posTaggedText;
    }
